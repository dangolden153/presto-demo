...
const SelectAvatar = () => {
    ...
    const { token, openModal, setOpenModal, setModalMessage, setRefresh, setLoading, loading, refresh } = useContext(Context);
    ...
    const handleAvatarUpdate = () => {
        dispatch(updateAvatar(imageUrl, token, setModalMessage, setOpenModal, handleRefresh, setLoading))
    }
    const avatar7 = "https://prestohq.io/wp-content/uploads/2022/03/Memoji-Boys-11-9.png"
            ...
            <View style={styles.container}>
                ...
                <View style={styles.inner_container}>
                    ...
                    <TouchableOpacity
                        ...
                        <Image source={{ uri: avatar7 }} style={{ width: 100, height: 100 }} />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        <Image source={{ uri: avatar1 }} style={{ width: 100, height: 100 }} />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        <Image source={{ uri: avatar2 }} style={{ width: 100, height: 100 }} />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        <Image source={{ uri: avatar3 }} style={{ width: 100, height: 100 }} />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        <Image source={{ uri: avatar4 }} style={{ width: 100, height: 100 }} />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        <Image source={{ uri: avatar5 }} style={{ width: 100, height: 100 }} />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        <Image source={{ uri: avatar6 }} style={{ width: 100, height: 100 }} />
                    </TouchableOpacity>
