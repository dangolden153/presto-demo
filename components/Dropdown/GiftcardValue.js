...
const GiftcardValue = ({navigation}) => {
  ...
  return (
    ...
    <NativeBaseProvider theme={theme}>
        ...
        <FormControl isRequired>
          ...
          <Text style={{fontSize: 16, marginBottom:5,fontFamily:"regular"}}>Giftcard value</Text>
          <View style={{width: "100%", alignSelf: "center",backgroundColor: "white", paddingHorizontal:10,borderRadius:10,}} >

          <Select
            // minWidth=""
            accessibilityLabel="Choose Service"
            placeholder="Select card Value"
            _selectedItem={{
              bg: "teal.600",
